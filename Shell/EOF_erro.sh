#!/bin/bash'
sed -i  's/","/@/g ;   s/^"/#/g ;   s/"\r$/#/g ;  s/"/'\''/g  ;  s/@/","/g ;   s/#/"/g'   'Alvara_de_Pesquisa.csv'
...
sed -i  's/";"/@/g ;   s/^"/#/g ;   s/"\r$/#/g ;  s/"/'\''/g  ;  s/@/";"/g ;   s/#/"/g'   'CFEM_Titulares_DadosAbertos.csv'
sed -i  's/";"/@/g ;   s/^"/#/g ;   s/"\r$/#/g ;  s/"/'\''/g  ;  s/@/";"/g ;   s/#/"/g'   'CFEM_Distribuicao.csv'
sed -i  's/";"/@/g ;   s/^"/#/g ;   s/"\r$/#/g ;  s/"/'\''/g  ;  s/@/";"/g ;   s/#/"/g'   'CFEM_Arrecadacao.csv'